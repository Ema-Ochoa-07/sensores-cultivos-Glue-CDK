    ...
    public JobGlueConectRDS(Construct scope, String id, IRole glueRole, DatabaseInstance rdsSensores, Bucket bucketSalida, String accountId) {
        ...
        CfnJob.Builder.create(this, "JobGlueConectRDS")
            ...
            .command(CfnJob.JobCommandProperty.builder()
                .name("glueetl")
                .scriptLocation("s3://aws-glue-scripts-" + accountId + "/scripts/extract-cultivo-rds-to-s3.scala")  // ✅ Eliminado el doble punto
                .language("scala")
                .build())
            .defaultArguments(Map.of(
                "--RDS_ENDPOINT", rds@@Sensores.getDbInstanceEndpointAddress(),
                "--RDS_DB_NAME", rdsSensores.getDatabaseName(),  // ✅ Corrección aquí
