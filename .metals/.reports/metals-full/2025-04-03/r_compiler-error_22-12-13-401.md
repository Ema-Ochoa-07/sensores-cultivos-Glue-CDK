...
public class EtlCultivoSensoresStack extends Stack {
    ...
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        // =============================================
            DatabaseInstance rdsSensores = Dat@@abaseInstance.Builder.create(this, "RdsSensoresCultivo")
            .engine(DatabaseInstanceEngine.mysql(MysqlEngineVersion.VER_8_0)) // ✅ CORREGIDO
