...
public class EtlCultivoSensoresStack extends Stack {
    ...
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        // =============================================
        Vpc vpc = Vpc.fromLookup(this, "SensorCultivoVpc", VpcLookupOptions.builder()
        .isDefault(true)
        .build());
        DatabaseInstance rdsSensores = DatabaseInstance.Builder.create(this, "RdsS@@ensoresCultivo")
