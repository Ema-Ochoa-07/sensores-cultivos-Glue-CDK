...
public class EtlCultivoSensoresStack extends Stack {
    ...
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        .build();
                ...
                // =============================================
                rdsSensores.getConnections().allowFromAnyIpv4(
    Port.tcp(3306),  // Sin "description:" (no es un parámetro nombrado)
    "Allow inbound MySQL access from any IP (testing only)"  // Descripción como string normal
);

        // ===================================================================
        // 3. GLUE DATABASE P@@ARA METADATOS
        // ====================================================================
