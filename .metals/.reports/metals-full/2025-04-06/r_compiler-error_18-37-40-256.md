...
public class EtlCultivoSensoresStack extends Stack {
    ...
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        // Definir la VPC que se va a utlizar en las difere@@mtes funciones
        ...
        // ================================================
        // 2.1 Otorgar permisos completos al usuario 'admin'
        // ================================================
        CfnDBInstance cfnDbInstance = (CfnDBInstance) rdsSensores.getNode().getDefaultChild();
        cfnDbInstance.addPropertyOverride("MasterUserPassword", rdsSensores.getSecret().getSecretValue().unsafeUnwrap());
        cfnDbInstance.addPropertyOverride("MasterUsername", "admin");
        cfnDbInstance.addPropertyOverride("DBName", "cultivo_bd");
