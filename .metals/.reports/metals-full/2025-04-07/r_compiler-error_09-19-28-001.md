...
import software.amazon.awscdk.services.rds.CredentialsFromSecretOptions;
...
public class EtlCultivoSensoresStack extends Stack {
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        // Bucket existente
        IBucket bucketSalida = Bucket.fromBucketName(this, "BucketSal@@ida", "datos-cultivo-procesados-164797387787-us-east-1");
