...
public class EtlCultivoSensoresStack extends Stack {
    ...
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        // =============================================
        // 5. SUBIR LOS SCRIPTS DE GLUE - PREVIO A LOS JOBS
        // =============================================
        ...
        // =======================================
        // Dependencia explícita: los jobs se crean solo después de que los scripts estén subidos
        JobGlueConectRDS jobExtraccion = new JobGlueConectRDS(this, "GlueJobExtraccion", glueRole, rdsSensores, bucketSalida, accountId);
        jobExtraccion.getNode().addDependency(uploader);

        JobGlueViewS3 jobTransformacion = new JobGlueViewS3(this, "Glu@@eJobTransformacion", glueRole, bucketSalida, accountId);
