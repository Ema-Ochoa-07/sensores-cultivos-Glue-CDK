...
public class RiegoCultivo implements RequestHandler<Map<String, Object>, Map<String, Object>> {
    ...
    @Override
    public Map<String, Object> handleRequest(Ma@@p<String, Object> input, Context context) {
        Map<String, Object> response = new HashMap<>();
        String secretName = "EtlCultivoSensoresStackRdsS-LxRUEOC2O2gm"; // tu secreto
        Region region = Region.US_EAST_1; // ajusta según región
