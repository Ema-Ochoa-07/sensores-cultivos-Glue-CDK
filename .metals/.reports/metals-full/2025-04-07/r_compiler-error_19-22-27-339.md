...
public class EtlCultivoSensoresStack extends Stack {
    ...
    public EtlCultivoSensoresStack(final Construct scope, final String id, final StackProps props) {
        ...
        public JobGlueConectRDS(final Construct scope, final String id, IRole glueJobRole, Bucket bucketSalida, String accountId, String outPath);
        ...
        jobTran@@sformacion.getNode().addDependency(uploader);
