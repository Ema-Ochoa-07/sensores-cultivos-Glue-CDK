...
public class JobGlueConectRDS extends Construct {
    ...
    public JobGlueConectRDS(final Construct scope, final String id, IRole glueJobRole, String outPath, String scriptLocation) {
        super(scope, id);
        ...
        defaultArgs.put("--extra-jars", "s3://datos-cultivo-procesados/driv@@ers/mysql-connector-j-9.2.0.jar");
